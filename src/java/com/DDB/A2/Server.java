...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader("src/java/com/DDB/A2/Server.config"));
            ...
            System.err.println("Make sure the Server.config file is in correct format");
